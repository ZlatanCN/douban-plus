...
`;
	...
	var TagSuggestionGroup = ({ disabled, label, onToggle, tags, value }) => u("div", {
	...
	var InterestTagEditor = ({ disabled, draft, myTags, onChange, onDraftChange, popularTags, tags }) => {
		...
		return u("section", {
			...
			children: [
				...
				myTags.length ? u(TagSuggestionGroup, {
					disabled,
					label: "我的标签",
					onToggle: toggleTag,
					tags: myTags,
				...
				popularTags.length ? u(TagSuggestionGroup, {
					disabled,
					label: "热门标签",
					onToggle: toggleTag,
					tags: popularTags,
	...
	var InterestFormFields = ({ disabled, form, onFormChange, onRetry, onTagDraftChange, onTagsChange, source, state, tagDraft }) => {
		...
		return u(S, { children: [
			...
			u("div", {
				class: "atv-interest-modal-settings",
				children: [u("label", {
					...
					children: [u("input", {
						...
						onChange: (event) => onFormChange({ isPrivate: event.currentTarget.checked }),
						type: "checkbox"
					...
					children: [u("input", {
						...
						onChange: (event) => onFormChange({ shareToBroadcast: event.currentTarget.checked }),
						type: "checkbox"
	...
	var InterestFormContent = ({ callbacks, onRetry, source, state }) => {
		const handleClose = useModalClose();
	...
	var InterestForm = ({ callbacks, onClose, onRetry, source, state }) => u(ModalShell, {
