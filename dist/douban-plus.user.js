...
`;
	...
	var LogoIqiyiCombined = (props) => u$1("svg", {
		width: "460",
		height: "72",
		viewBox: "0 0 460 72",
		fill: "none",
		...
		children: [u$1("path", {
			...
			children: [u$1("stop", { "stop-color": "#00DC5A" }), u$1("stop", {
				offset: "1",
				"stop-color": "#00DC5A"
			})]
		}) })]
	});
	var LogoYoukuCombined = (props) => u$1("svg", {
		width: "213",
		height: "72",
		viewBox: "0 0 213 72",
		fill: "none",
		...
		children: [
			...
			u$1("defs", { children: [u$1("linearGradient", {
				...
				y2: "554.74",
				gradientUnits: "userSpaceOnUse",
				children: [u$1("stop", { "stop-color": "#FF8000" }), u$1("stop", {
					offset: "1",
					"stop-color": "#FF6400"
				})]
			}), u$1("linearGradient", {
	...
	var LogoTencentCombined = (props) => u$1("svg", {
		width: "284",
		height: "72",
		viewBox: "0 0 284 72",
		fill: "none",
	...
	var LogoBilibiliCombined = (props) => u$1("svg", {
		width: "140",
		height: "64",
		viewBox: "0 0 140 64",
		fill: "none",
	...
	var PosterModal = ({ alt, onClose, src }) => u$1(ModalShell, {
		ariaLabel: "海报预览",
		className: "atv-modal-overlay",
		id: MODAL_ID$1,
		onClose,
		surfaceClassName: "atv-modal-surface",
		children: u$1(PosterModalContent, {
			alt,
			src
		})
	});
	...
	var VideoModalContent = ({ trailer }) => {
		...
		return u$1(S, { children: [u$1(ModalCloseButton, {
			...
			children: [
				state.status === "loading" ? u$1("div", {
					class: "atv-modal-loading",
					children: [u$1("div", { class: "atv-spinner" }), u$1("span", { children: "加载中..." })]
				}) : null,
				state.status === "loaded" ? u$1("video", {
					autoplay: true,
	...
	var VideoModal = ({ onClose, trailer }) => u$1(ModalShell, {
		ariaLabel: trailer.title || "视频预览",
		className: "atv-modal-overlay is-video",
		id: MODAL_ID,
		onClose,
		surfaceClassName: "atv-modal-surface",
		children: u$1(VideoModalContent, { trailer })
	});
	...
	var CommentModalContent = ({ canVote, comment, onVoteStateChange, onVote, voteState }) => {
		...
		return u$1(S, { children: [
			u$1("div", { class: "atv-modal-accent-bar atv-comment-overlay-accent" }),
  ...
  title(id: $id) {
		...
		children: u$1("div", {
			...
			children: streaming.map((item) => {
				...
				return u$1("a", {
					...
					style,
					target: "_blank",
					children: provider.combinedSvg && provider.Icon ? u$1(provider.Icon, {}) : u$1(S, { children: [u$1(StreamingLogo, {
	...
	var ReviewModalContent = ({ canVote, onVoteStateChange, onVote, review, voteState }) => {
		...
		return u$1(S, { children: [
			...
			u$1("div", { class: "atv-modal-accent-bar atv-review-modal-accent" }),
			u$1("div", {
	...
	var LoginModalContent = ({ action, busy, hostRef, status }) => {
		const handleClose = useModalClose();
		return u$1(S, { children: [
			u$1("div", { class: "atv-modal-accent-bar atv-login-modal-accent" }),
			u$1(ModalCloseButton, {
				ariaLabel: "关闭登录弹窗",
	...
	var InterestFormContent = ({ callbacks, state }) => {
		...
		return u$1(S, { children: [
			u$1("div", { class: "atv-modal-accent-bar atv-interest-modal-accent" }),
			u$1("div", {
