			...
			children: discussions.topics.map((topic, index) => u("article", {
				...
				children: [
					...
					u("div", {
						...
						}), topic.author ? u(DiscussionAuthorLink, { author: topic.author }) : null]
					}),
					topic.replies !== void 0 || topic.activity ? u("div", {
						class: "atv-discussion-activity",
						children: [topic.replies === void 0 ? null : u("span", {
							class: "atv-discussion-replies",
							children: `${topic.replies} 回应`
						}), topic.activity ? u(DiscussionActivityTime, { activity: topic.activity }) : null]
					}) : null,
					u("span", {
						"aria-hidden": "true",
