...
type PersonageNavSection = { id: string; label: string };

type PersonageStickyNavigation = {
  activeSectionId: string;
  navRef: { current: HTMLElement | null };
  onJump: (sectionId: string) => void;
  scrolling: boolean;
  sections: readonly PersonageNavSection[];
  visible: boolean;
};

const usePersonageStickyNavigation = (
  doc: Document,
  sections: PersonageNavSection[]
): PersonageStickyNavigation => {
...
export { usePersonageStickyNavigation };
export type { PersonageNavSection, PersonageStickyNavigation };
