...
const ICON_STAR_EMPTY =
  ...
  "</svg>";
const LOGO_DOUBAN =
  '<svg viewBox="0 0 24 24" width="24" height="24" aria-label="豆瓣" fill="#2D963D">' +
  ...
  "</svg>";
const LOGO_IMDB =
  '<svg viewBox="0 0 24 24" width="24" height="24" aria-label="IMDb" fill="#F5C518">' +
  ...
  "</svg>";
const LOGO_METACRITIC =
  '<svg viewBox="0 0 24 24" width="24" height="24" aria-label="Metacritic" fill="#FFD500">' +
  ...
  "</svg>";
const LOGO_RT =
  '<svg viewBox="0 0 24 24" width="24" height="24" aria-label="Rotten Tomatoes" fill="#FA320A">' +
